...
def cli_coordinates_input()->tuple:
    ...
    Returns:
    coordinate : tuple with first value indicating row inputted and second value indicating column inputted returns False if a string is entered, and None if q is entered
    '''
