...
def create_battleships(filename:str='battleships.txt')->dict:
    ...
    Args:
    filename : file to be read with ship information of format ship_name:size, default of battleships.txt
...
def place_battleships(board:list[list], ships:dict,placement:str='simple',custom_json = 'placement.json')->list[list]:
    ...
    placement : string indicating what algorithm of placement to use, default of 'simple'. Can take values 'simple','random','custom'
